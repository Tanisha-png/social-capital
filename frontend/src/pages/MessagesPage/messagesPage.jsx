...
// import { markMessageNotificationsRead } from "../../services/notificationApi"; // ✅ add this
...
//   const { setHasNewMessage } = useMessageNotifications();
...
//       ) {
//         // Only add if the message isn't from the current user
...
//       await markMessageNotificationsRead(u._id, token);
//     } catch (err) {
