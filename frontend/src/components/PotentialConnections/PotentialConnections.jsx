...
// src/components/PotentialConnections/PotentialConnections.jsx
import React, { useState, useEffect } from "react";
import * as authService from "../../services/authService";
import Avatar from "../Avatar/Avatar";
import { getSafeAvatarUrl } from "../Avatar/Avatar";
import "./PotentialConnections.css";
  ...
  return (
    <div className="potential-connections">
      ...
      <ul>
        {results.map((u) => (
          <li key={u._id}>
            <Avatar src={getSafeAvatarUrl(u.avatar || u.profileImage, u._id)} alt={`${u.firstName} ${u.lastName}`} />
